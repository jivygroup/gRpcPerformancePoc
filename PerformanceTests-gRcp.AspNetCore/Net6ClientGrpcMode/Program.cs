...
using StreamingApiClient = StreamingApi.Protos.StreamingApi.StreamingApiClient;
...
namespace SCM_GrpcNetCore
{
    partial class Program
    {
        ...
        private static ILightStreamerProxyClient GetGrpcClient(string host, int port, ChannelCredentials channelCredentials)
        {
            ...
            var client = new StreamingApiClient(channel);
            return new LightStreamerProxyClient(client);
        }
